...
int main(){
    ...
    while(ejercicio != -1){
        ...
        case 2: printf("Ejercicio 2\n");
            ...
            while(subejercicio != -1){
                ...
                case 4: printf("d. Contar los elementos de la cola.\n");
                    ...
                    break;
                case 5: printf("e. Realizar una funcion que realice una copia de una cola\n");
        ...
        case 3: printf("Ejercicio 3\n");
                ...
                c_destruir(c);
                c_destruir(c_2);
                printf("Complejidad algortimica O(n) = n (Lineal).\n");
            break;
        case 4: printf("Ejercicio 4\n");
                ...
                c_mostrar(c_resultado);
                c_destruir(c_resultado);
                printf("Complejidad algortimica O(n) = n^2 (Cuadratica).\n");
            break;
        ...
        case 7: printf("Ejercicio 7\n");
                ...
                valor = c_ej2_contarelementos(c) + c_ej2_contarelementos(c_2) + c_ej2_contarelementos(c_3);
                while(valor > 100){
                    printf("La cantidad de clientes excede la capacidad de atencion.\n");
                    c_destruir(c);
                    c_destruir(c_2);
                    c_destruir(c_3);
                    printf("Cargue la cola 1.\n");
